...
import com.khametov.rsttour.screens.main.domain.entity.FlightStatus
        ...
        content = {
            Column(
                ...
                content = {
                    ...
                    StatusView(status = FlightStatus.Canceled)
...
private fun ConstraintLayoutScope.TrajectoryView(
    ...
    ConstraintLayout(
        ...
        content = {
            ...
            Image(
                painter = painterResource(id = R.drawable.icv_tab_chat),
                contentDescription = null,
                modifier = Modifier.constrainAs(
                    ref = plane,
                    constrainBlock = {
...
private fun StatusView(status: FlightStatus) {
    ...
    Text(
        text = stringResource(id = R.string.chat_tab_title),
        style = AeroTheme.typography.subMedRoboto,
        color = AeroTheme.colors.secondaryText,
